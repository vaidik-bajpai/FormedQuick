    ...
    return (
        <h1 className='flex-none sticky top-0 left-0 py-4 px-12 w-full bg-background border-b border-border'>
            <div className='mx-auto flex justify-between items-center'>
                ...
                <Button variant="outline" size="lg" className='font-bold !bg-primary/90 !text-primary-foreground border-2 border-border hover:!bg-primary hover:cursor-pointer' onClick={() => router.push("/signin")}>Get started</Button>
            </div>  
        </h1>
    )
}
